  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4 auto-rows-[200px]">
        ...
        <Link
          to="/cards"
          className="md:col-span-3 md:row-span-2 bg-gradient-to-br from-purple-600/20 to-purple-800/20 backdrop-blur-md rounded-xl border border-purple-500/30 p-6 hover:border-purple-500/60 hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-300 group flex flex-col justify-between"
        >
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white group-hover:text-purple-400 transition-colors">Card Browser</h3>
                <p className="text-sm text-gray-400">30,224 records</p>
              </div>
            </div>
        ...
        {/* Social Links */}
        <div className="md:col-span-2 bg-gradient-to-br from-orange-600/20 to-orange-800/20 backdrop-blur-md rounded-xl border border-orange-500/30 p-6 flex flex-col justify-between">
          <div>
            <h3 className="text-lg font-bold text-white mb-4">Connect With Us</h3>
            <div className="space-y-3">
              <a href="#" className="flex items-center space-x-3 text-gray-300 hover:text-orange-400 transition-colors group">
        ...
        <Link
          to="/stats"
          className="md:col-span-2 bg-gradient-to-br from-cyan-600/20 to-cyan-800/20 backdrop-blur-md rounded-xl border border-cyan-500/30 p-6 hover:border-cyan-500/60 hover:shadow-xl hover:shadow-cyan-500/20 transition-all duration-300 group flex flex-col justify-between"
        >
          <div>
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white group-hover:text-cyan-400 transition-colors">Statistics</h3>
              </div>
            </div>
