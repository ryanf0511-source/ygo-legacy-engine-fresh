  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4 auto-rows-[200px]">
        ...
        <Link
          to="/schedule"
          className="md:col-span-2 bg-gradient-to-br from-red-600/20 via-rose-600/20 to-red-800/20 backdrop-blur-md rounded-xl border border-red-500/40 p-6 hover:border-red-400/80 hover:shadow-xl hover:shadow-red-500/30 transition-all duration-300 group flex flex-col justify-between"
        >
          <div>
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white group-hover:text-red-400 transition-colors">Streaming</h3>
              </div>
            </div>
            <p className="text-gray-300 text-sm mb-2">Next stream:</p>
            <p className="text-red-400 font-bold">Saturday @ 7:00 PM</p>
