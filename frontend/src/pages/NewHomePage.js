  ...
  return (
    <div className="space-y-12">
      ...
      <div className="text-center max-w-5xl mx-auto space-y-6">
        ...
        <div className="relative bg-gradient-to-br from-black/95 via-stone-950/95 to-black/95 rounded-2xl border-2 border-yellow-600/50 p-10 shadow-2xl shadow-yellow-900/20 overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link
          to="/cards"
          className="group relative h-80 bg-gradient-to-br from-black via-stone-950 to-black rounded-2xl border-2 border-yellow-600/40 overflow-hidden hover:border-yellow-500/80 transition-all duration-500 hover:shadow-2xl hover:shadow-yellow-900/40"
        >
          ...
          <div className="relative h-1/2 flex items-center justify-center bg-gradient-to-b from-yellow-900/20 via-yellow-900/10 to-transparent">
            ...
            <div className="relative z-10 p-6 transform group-hover:scale-110 transition-transform duration-500">
              <div className="p-4 bg-yellow-600/20 rounded-2xl border-2 border-yellow-500/50 shadow-2xl shadow-yellow-900/50">
          ...
          <div className="h-1/2 p-6 flex flex-col justify-center">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">Search and explore card usage across all SJC tournaments</p>
          </div>
        </Link>
        ...
        <Link
          to="/decklists"
          className="group relative h-80 bg-gradient-to-br from-black via-stone-950 to-black rounded-2xl border-2 border-yellow-600/40 overflow-hidden hover:border-emerald-500/80 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-900/40"
        >
          <div className="absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500"
            style={{
              background: `linear-gradient(45deg, 
          ...
          <div className="relative h-1/2 flex items-center justify-center bg-gradient-to-b from-emerald-900/20 via-emerald-900/10 to-transparent">
          ...
          <div className="h-1/2 p-6 flex flex-col justify-center">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">Browse tournament-winning decklists with advanced filtering</p>
          </div>
        </Link>
        ...
        <Link
          to="/master-lists"
          className="group relative h-80 bg-gradient-to-br from-black via-stone-950 to-black rounded-2xl border-2 border-emerald-600/50 overflow-hidden hover:border-emerald-500/80 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-900/40"
        >
          <div className="absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500"
            style={{
              background: `linear-gradient(45deg, 
                rgba(0,255,128,0.1) 0%, 
                rgba(64,255,192,0.1) 25%, 
                rgba(0,255,255,0.1) 50%, 
                rgba(0,255,128,0.1) 75%, 
                rgba(64,255,192,0.1) 100%)`,
              backgroundSize: '200% 200%',
              animation: 'shimmer 3s linear infinite'
            }}
          ></div>
          ...
          <div className="relative h-1/2 flex items-center justify-center bg-gradient-to-b from-emerald-900/20 via-emerald-900/10 to-transparent">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-600/20 via-transparent to-transparent"></div>
            <div className="relative z-10 p-6 transform group-hover:scale-110 transition-transform duration-500">
              <div className="p-4 bg-emerald-600/20 rounded-2xl border-2 border-emerald-500/50 shadow-2xl shadow-emerald-900/50">
          ...
          <div className="h-1/2 p-6 flex flex-col justify-center">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">Complete card inventories for different formats</p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="h-1/2 p-6 flex flex-col justify-center">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">Pick two decks from any SJC event for battle</p>
          </div>
        </Link>
        ...
        >
          <div className="absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500"
            style={{
              background: `linear-gradient(45deg, 
                ...
                rgba(128,128,255,0.1) 25%, 
                rgba(255,0,255,0.1) 50%, 
                rgba(0,255,255,0.1) 75%, 
                rgba(128,128,255,0.1) 100%)`,
              backgroundSize: '200% 200%',
              animation: 'shimmer 3s linear infinite'
            }}
          ></div>
          
          <div className="relative h-1/2 flex items-center justify-center bg-gradient-to-b from-cyan-900/20 via-cyan-900/10 to-transparent">
          ...
          <div className="h-1/2 p-6 flex flex-col justify-center">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">View trends and popular cards from SJC history</p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="relative h-1/2 flex items-center justify-center bg-gradient-to-b from-red-900/20 via-red-900/10 to-transparent">
          ...
          <div className="h-1/2 p-6 flex flex-col justify-center">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">Live Yu-Gi-Oh! content and tournaments</p>
          </div>
        </Link>
      </div>

      {/* Social Links Section */}
      <div className="relative bg-gradient-to-br from-black/95 via-stone-950/95 to-black/95 rounded-2xl border-2 border-yellow-600/40 p-8 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-center space-x-8">
            <a href="#" className="flex flex-col items-center space-y-2 text-gray-300 hover:text-emerald-400 transition-colors group">
              <div className="p-3 bg-yellow-600/10 rounded-xl border border-yellow-500/30 group-hover:border-emerald-500/50 transition-colors">
